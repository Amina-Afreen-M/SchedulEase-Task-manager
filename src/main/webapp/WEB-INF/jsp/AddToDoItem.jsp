...
<body>
        ...
        <form:form action="/saveToDoItem" method="post" modelAttribute="todo">
            ...
            <div id="timer" class="row">
                <div class="form-group col-md-12">
                    ...
                    <input type="hidden" id="timeSpentInput" name="timeSpent" value="0"> <!-- Hidden field -->
                </div>
            </div>
    ...
    <script>
        ...
        function stopTimer() {
            ...
            document.getElementById('timeSpentInput').value = timeSpent; // Store time spent in the hidden input
        }
    </script>
